...
def analyze_images(path_ext, path_out):
    ...
    th_factor = 0.4                  # Fraction of maximum brightness. Pixels having this brightness fraction is assumed to be part of the object
    ...
    obj_size_th_factor = 0.5          # for composite mask from fragments, size of object to include = max_size * obj_size_th_factor 
